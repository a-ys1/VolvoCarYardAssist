...
public class SetAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button = findViewById(R.id.btn_setCoord);
    ...
    private void getLocation() {
        if (ContextCompat.checkSelfPermission(SetAreaActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        if(mode == 2){
                            ...
                            Toast.makeText(SetAreaActivity.this, "Bottom Left coordinates received:" + botL.lat + "," + botL.lon, Toast.LENGTH_SHORT).show();
                            TextView show2coord = findViewById(R.id.textBLC);
                            show2coord.setText("Bottom Left: " + botL.lat + ", " + botL.lon);
                            TextView cGuide = findViewById(R.id.textCornerG);
                            cGuide.setText("Done!");
                            Button setBtn = findViewById(R.id.btn_setCoord);
                            setBtn.setClickable(false);

                            uploadToFb(topL, topR, botL);
                            area = getArea();
                            TextView showArea = findViewById(R.id.showArea);
                            ...
                            TextView show1coord = findViewById(R.id.textTRC);
                            show1coord.setText("Top Right: " + topR.lat + ", " + topR.lon );
                            Toast.makeText(SetAreaActivity.this, "Top Right Coordinates received:" + topR.lat + "," + topR.lon, Toast.LENGTH_SHORT).show();
                            TextView cGuide = findViewById(R.id.textCornerG);
                            ...
                            TextView show1coord = findViewById(R.id.textTLC);
                            show1coord.setText("Top Left: " + topL.lat + ", " + topL.lon );
                            Toast.makeText(SetAreaActivity.this, "Top Left Coordinates received:" + topL.lat + "," + topL.lon, Toast.LENGTH_SHORT).show();
                            TextView cGuide = findViewById(R.id.textCornerG);
                        ...
                        Toast.makeText(SetAreaActivity.this, "There is no location data! (Location == null)", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
            ...
            ActivityCompat.requestPermissions(SetAreaActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(SetAreaActivity.this, "Permission granted", Toast.LENGTH_SHORT).show();

            } else {
                Toast.makeText(SetAreaActivity.this, "Permission denied", Toast.LENGTH_SHORT).show();
            }
        }
